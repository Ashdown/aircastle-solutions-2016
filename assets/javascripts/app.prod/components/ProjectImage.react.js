(function(react, app) {
    ...
    App.Components.ProjectImage = React.createClass({displayName: "ProjectImage",
        render: function() {
            ...
            return(
                React.createElement("img", {className: "project-image " + this.props.extraClass, onLoad: imageLoaded, src: data.url, alt: data.alt, height: data.height, width: data.width})
                )
        }
    })
