(function(App, React, Helpers) {
    ...
    App.Components.Portfolio = React.createClass({displayName: "Portfolio",
        ...
        render: function() {
            return(
                React.createElement("div", null, 
                    React.createElement(App.Components.Search, {data: this.state.keywords, filter: this.filterProjectsByKeyword}), 
                    React.createElement(App.Components.ResultsCount, {data: this.state.projectData}), 
