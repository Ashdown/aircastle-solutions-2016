(function(React, App){
    ...
    App.Svg.CloseSvg = React.createClass({displayName: "CloseSvg",
        render: function() {

            return(
                React.createElement("svg", {className: "close-svg", x: "0px", y: "0px", viewBox: "0 0 27.965 27.965"}, 
                    React.createElement("g", null, 
                        React.createElement("g", {id: "c142_x"}, 
                            React.createElement("path", {className: "path", d: "M13.98,0C6.259,0,0,6.261,0,13.983c0,7.721,6.259,13.982,13.98,13.982c7.725,0,13.985-6.262,13.985-13.982" + ' ' +
